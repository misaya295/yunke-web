export default {
  ...
  table: {
    ...
    routeLogin: {
      ...
      title: 'Yunke Gateway Certification',
      login: 'Login'
    },
    refresh: 'Refresh',
    operation: 'Operation',
  ...
  tips: {
    ...
    neverLogin: 'Never logged in to the Yunke system',
    nothing: 'Nothing',
    ...
    iframeGrant: 'Userame: yunke Password: 123456',
  ...
  common: {
    system: 'Auth System',
    desc: {
      a: 'Based on Spring Boot 2.3.0 & Spring Security',
