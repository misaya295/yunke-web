<template>
  ...
  >
    ...
    <el-row :gutter="10">
      <el-col :xs="24" :sm="12">
        <div class="view-item">
          <i class="el-icon-reading" /> <span>证书：</span> {{ tasks.certificate }}
        </div>
      </el-col>
      <el-col :xs="24" :sm="12">
        <div class="view-item">
          <i class="el-icon-reading" /> <span>申请书：</span> {{ tasks.application_form }}
        </div>
      </el-col>
    </el-row>
    <el-row :gutter="10">
    ...
    <el-row :gutter="10">
      <el-col :xs="24" :sm="12">
        <div class="view-item">
          <i class="el-icon-document" /> <span>软件协议：</span> {{ tasks.agreement }}
        </div>
      </el-col>
      <el-col :xs="24" :sm="12">
        <div class="view-item">
