  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <div class="filter-item">
        <el-date-picker
          v-model="funding.applyTime"
          type="daterange"
          :range-separator="null"
          start-placeholder="提交申报日期"
          end-placeholder="提交申报日期"
      ...
      <div class="filter-item">
        <el-date-picker
          v-model="funding.successTime"
          type="daterange"
          :range-separator="null"
          start-placeholder="申报完成日期"
          end-placeholder="申报完成日期"
          value-format="yyyy-MM-dd"
          class="search-item"
          style="width:255px"
        />
      ...
      <el-table ref="table" :data="fundingTableData" style="width:100%" border fit @selection-change="onSelectChange">
        ...
        >
          <template slot-scope="scope">
            ...
            />
            <i
              v-if="handleJudgeUpdate(scope.row)"
            ...
            />
            <i
              v-if="handleJudgeDelete(scope.row)"
      ...
      <el-dialog :title="temp.state | ViewTextFilter" :visible.sync="fundingViewVisible" :width="width">
        ...
        <el-row :gutter="10">
          ...
          <el-col :xs="24" :sm="12">
            <div class="view-item">
              <i class="el-icon-s-ticket" /> <span>发票: </span> <i
                class="el-icon-view table-operation"
                @click="onPreview"
              />
        ...
        <div v-if="handleJudgePass(temp)" slot="footer" class="dialog-footer">
        ...
        <div v-if="handleJudgeSuccess(temp)" slot="footer" class="dialog-footer">
  ...
  methods: {
    ...
    loadTable() {
      ...
      this.$get('studio/funding', {
        ...
        this.fundingHidePage = this.page.total == 0
      })
    },
    ...
    importFunding() {
      this.$get(`/studio/${this.taskType}/`, {
        ...
        this.teskHidepage = this.taskTotal === 0
      })
    },
    submitForm(formName) {
