<template>
  ...
  >
    ...
    <el-row :gutter="10">
      ...
      <el-col :xs="24" :sm="12">
        <div class="view-item">
          <i class="el-icon-bell" /> <span>{{ $t('table.user.updateTime') +'：' }}</span>
          {{ user.updateTime }}
        </div>
      </el-col>
    </el-row>
    <el-row :gutter="10">
      <el-col :xs="24" :sm="12">
        <div class="view-item">
          <i class="el-icon-magic-stick" /> <span>{{ $t('table.user.noteName') +'：' }}</span> {{ user.noteName }}
        </div>
      </el-col>
      <el-col :xs="24" :sm="12">
        <div class="view-item">
          <i class="el-icon-circle-check" /> <span>{{ $t('table.user.lastLoginTime') +'：' }}</span>
          {{ user.lastLoginTime }}
        </div>
      </el-col>
    </el-row>
    <el-row :gutter="10">
      ...
      <el-col :xs="24" :sm="12">
        <div class="view-item">
          <i class="el-icon-news" /> <span>{{ $t('table.user.fullName') +'：' }}</span>
          {{ user.fullName }}
        </div>
      </el-col>
    </el-row>
