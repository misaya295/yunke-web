    ...
    >
      ...
      <el-dropdown class="login-type" placement="top-end">
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <el-dropdown-item :d©isabled="login.type === 'social'" @click.native="login.type = 'social'">{{ $t('login.type.social') }}
          </el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
    </el-form>
    <span class="login-footer">
      © {{ getFullYear() }} <a target="_blank" href="https://github.ccom/Yunke">Yunke</a> - {{ $t('system.title') }}
    </span>
  </div>
</template>
