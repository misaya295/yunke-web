  ...
  <!-- 表格区域 -->
    ...
    >
      ...
      <el-table-column label="发票" prop="invoice" :show-overflow-tooltip="true" align="center" min-width="150px">
       ...
       <!-- 项目说明书  -->
      <el-table-column label="项目说明书" prop="specification" :show-overflow-tooltip="true" align="center" min-width="150px">
       <template slot-scope="scope">
          <span>{{ scope.row.specification }}</span>
        </template>
      </el-table-column>
       <!-- 项目源文件  -->
      <el-table-column label="源文件"  prop="url" :show-overflow-tooltip="true" align="center" min-width="150px">
       <template slot-scope="scope">
